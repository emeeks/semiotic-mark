  ...
  _createClass(Mark, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      var oldProps = Object.keys(this.props).filter(function (d) {
        return d !== "style" && !newProps.find(d);
      });
      ...
      newProps.forEach(function (newProp) {
        if (!hasTransition || !_markTransition.attributeTransitionWhitelist.find(newProp) || newProp === "d" && (0, _markTransition.differentD)(cloneProps.d, _this2.props.d)) {
